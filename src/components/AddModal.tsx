...
interface AddModalProps {
  onSelect: (option: "order" | "receive") => void;
  onClose: () => void;
}

export function AddModal({ onSelect, onClose }: AddModalProps) {
  const [selected, setSelected] = useState<"order" | "receive" | null>(null);
      ...
      >
        ...
        <div className="space-y-4 mb-8">
          ...
          <button
            ...
            style={{
              borderColor: selected === "order" ? '#4CAF50' : '#E0E0E0',
              minHeight: '70px',
            ...
            <div className="flex items-center">
              <div
                ...
                style={{
                  ...
                  height: '24px',
                  borderColor: selected === "order" ? '#4CAF50' : '#E0E0E0',
                  backgroundColor: selected === "order" ? '#4CAF50' : 'transparent',
                }}
              />
              <span className="text-black text-sm sm:text-base">Order Stock</span>
            </div>
          </button>
          ...
          <button
            ...
            className="w-full bg-white border-4 rounded-2xl flex items-center p-4 transition-all hover:shadow-lg"
            style={{
              borderColor: selected === "receive" ? '#4CAF50' : '#E0E0E0',
              minHeight: '70px',
              transition: 'all 250ms ease',
            }}
          >
            <div className="flex items-center">
              <div
                ...
                style={{
                  ...
                  height: '24px',
                  borderColor: selected === "receive" ? '#4CAF50' : '#E0E0E0',
                  backgroundColor: selected === "receive" ? '#4CAF50' : 'transparent',
                }}
              />
              <span className="text-black text-sm sm:text-base">Receive Delivery</span>
            </div>
          </button>
        </div>
